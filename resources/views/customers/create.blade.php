...
@section('content')
    <div class="w-full space-y-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-semibold text-primary tracking-tight">Create Customer</h1>
                <p class="text-sm font-medium text-themeMuted mt-1">Add a new customer record</p>
            </div>
