...
@section('content')
    <div class="w-full">
        <div class="mb-6 flex justify-between items-center">
            <h1 class="text-3xl font-semibold text-primary tracking-tight">Create Branch</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="head_branch_id" name="head_branch_id" disabled
                            ...
                            @if (isset($userBranchId) && $userBranchId)
                                @php $userBranch = \App\Models\Branch::find($userBranchId); @endphp
                                @if ($userBranch)
                        ...
                        @endif
                        <p class="mt-1 text-xs font-medium text-themeMuted">This branch will belong to your current branch</p>
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <textarea id="address" name="address" rows="2" placeholder="Optional"
                            class="w-full px-4 py-2.5 border border-themeBorder rounded-xl text-themeHeading placeholder-themeMuted focus:ring-2 focus:ring-primary/20 focus:border-primary transition">{{ old('address') }}</textarea>
                    </div>
                    <div>
