...
@section('content')
    <div class="w-full">
        <div class="mb-6 flex justify-between items-center">
            <h1 class="text-3xl font-semibold text-primary tracking-tight">Edit User</h1>
        ...
        <div
            ...
            <form method="POST" action="{{ route('users.update', $user) }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="branch" class="block text-themeBody font-medium mb-2">Branch</label>
                        <input type="text" id="branch" value="{{ $user->branch->name ?? 'No Branch' }}" disabled
