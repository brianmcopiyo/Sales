...
@section('content')
    <div class="w-full">
        <div class="mb-6 flex justify-between items-center">
            <h1 class="text-3xl font-semibold text-primary tracking-tight">Edit Region</h1>
            ...
            <form method="POST" action="{{ route('regions.update', $region) }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $region->name) }}"
                            required
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="3" placeholder="Optional"
                            class="w-full px-4 py-2.5 border border-themeBorder rounded-xl text-themeHeading placeholder-themeMuted focus:ring-2 focus:ring-primary/20 focus:border-primary transition">{{ old('description', $region->description) }}</textarea>
                    </div>
