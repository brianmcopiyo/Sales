...
<div class="w-full space-y-6">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-3xl font-semibold text-primary tracking-tight">Create Device</h1>
            <p class="text-sm font-medium text-themeMuted mt-1">Register a new device by IMEI</p>
        </div>
        ...
        <form method="POST" action="{{ route('devices.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="imei" name="imei" value="{{ old('imei') }}" required maxlength="15" pattern="[0-9]{15}"
                ...
                <div>
                    ...
                    <p class="text-xs font-medium text-themeMuted mt-1">Devices are always created as "Available"</p>
                </div>
