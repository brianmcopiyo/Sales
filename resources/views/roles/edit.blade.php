...
@section('content')
    <div class="w-full space-y-6">
        <div class="flex justify-between items-center">
            <h1 class="text-3xl font-semibold text-primary tracking-tight">Edit Role</h1>
            <a href="{{ route('roles.index') }}"
                class="bg-themeHover text-themeBody px-4 py-2 rounded hover:bg-themeBorder transition font-light flex items-center space-x-2">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3"
                            class="w-full px-4 py-2.5 border border-themeBorder rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary font-medium text-themeHeading">{{ old('description', $role->description) }}</textarea>
                        @error('description')
                            <p class="text-xs text-red-600 font-medium mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                                        ...
                                        <label
                                            ...
                                            <div class="flex items-start space-x-2 w-full">
                                                <input type="checkbox" name="permissions[]" value="{{ $permission->id }}"
                                                    ...
                                                    class="mt-1 rounded border-themeBorder text-primary focus:ring-primary permission-checkbox">
