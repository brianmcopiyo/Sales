...
<head>
    ...
    <title>503 - Service Unavailable | Stock Management</title>
...
<body class="bg-themeInput flex items-center justify-center min-h-screen font-medium">
    <div class="max-w-md w-full px-4">
        <div
            ...
            <h1 class="text-6xl text-primary font-semibold mb-4">503</h1>
            <h2 class="text-2xl text-themeHeading font-semibold mb-3">Service Unavailable</h2>
            <p class="text-themeBody font-medium mb-8">
                We're temporarily down for maintenance. We'll be back shortly. Thank you for your patience.
            </p>
            <div class="space-y-3">
