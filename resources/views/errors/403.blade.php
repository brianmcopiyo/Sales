...
<head>
    ...
    <title>403 - Forbidden | Stock Management</title>
...
<body class="bg-themeInput flex items-center justify-center min-h-screen font-medium">
    <div class="max-w-md w-full px-4">
        <div
            ...
            <h1 class="text-6xl text-primary font-semibold mb-4">403</h1>
            <h2 class="text-2xl text-themeHeading font-semibold mb-3">Access Forbidden</h2>
