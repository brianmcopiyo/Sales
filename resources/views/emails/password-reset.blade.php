    ...
    <div style="padding: 20px;">
        <div class="email-container">
            <div class="email-header">
                ...
                <h2 class="email-subtitle">Password Reset Request</h2>
            </div>
            <div class="email-body">
                ...
                <p class="email-content" style="font-size: 14px; margin-bottom: 16px;">
                    If the button doesn't work, copy and paste this link into your browser:
                </p>
                <div class="link-text">{{ $resetUrl }}</div>
                <p class="info-text">This link will expire in 6 hours and can only be used once.</p>
